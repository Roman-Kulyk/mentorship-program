...
class CheckoutPage1(MainPage):
    ...
    def enter_first_name(self, first_name: str) -> None:
        ...
        """
        self.first_name_input = self.driver.find_element(
            By.XPATH, FIRST_NAME)
    ...
    def enter_last_name(self, last_name: str) -> None:
        ...
        """
        self.last_name_input = self.driver.find_element(
            By.XPATH, LAST_NAME)
    ...
    def enter_postal_code(self, postal_code: str) -> None:
        ...
        """
        self.postal_code_input = self.driver.find_element(
            By.XPATH, ZIP)
    ...
    def click_continue(self) -> None:
        ...
        self.continue_button = self.driver.find_element(
            By.XPATH, CONTINUE)
