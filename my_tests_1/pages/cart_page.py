...
class CartPage(MainPage):
    ...
    def continue_shopping(self, locator):
        """This is a method to define continue shopping button."""
        self.continue_shopping_button = self.driver.find_element(By.XPATH, locator)
        self.continue_shopping_button.click()
 
    def checkout(self, locator):
        """This is a method to define checkout button."""
        self.checkout_button = self.driver.find_element(By.XPATH, locator)
